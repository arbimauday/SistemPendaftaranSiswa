...
<head>
  ...
  <title>Administrator | KOMINFO</title>
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a class="nav-link" href="/pendaftaran">
                ...
                <p>
                  Pendaftaran
                  <!-- <span class="right badge badge-info">{{$pendaftarans->count()}}</span> -->
                </p>
              </a>
            </li>
...
{{--        <b>Version</b> 3.2.0--}}
{{--      </div>--}}
{{--      <strong>Copyright &copy; {{date('Y')}} <a href="https://adminlte.io">AdminLTEi.o</a>.</strong> All rights reserved.--}}
{{--    </footer>--}}
